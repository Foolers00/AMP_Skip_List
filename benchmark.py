...
def benchmark():
    ...
    operations = 16000
    repetitions = 3
    smallbench_16000_3_10p = Benchmark(binary.small_bench, (operations,3,10,10), repetitions,
                               num_threads, basedir, "smallbench_16000_3_10p", curr_time)
    smallbench_16000_3 = Benchmark(binary.small_bench, (operations,3,25,25), repetitions,
                               num_threads, basedir, "smallbench_16000_3", curr_time)
    smallbench_16000_5 = Benchmark(binary.small_bench, (operations,5,25,25), repetitions,
                               num_threads, basedir, "smallbench_16000_5", curr_time)
    smallbench_16000_10 = Benchmark(binary.small_bench, (operations,10,25,25), repetitions,
                               num_threads, basedir, "smallbench_16000_10", curr_time)

    smallbench_16000_3_10p.run()
    smallbench_16000_3_10p.write_avg_data()
    smallbench_16000_3.run()
    smallbench_16000_3.write_avg_data()
    smallbench_16000_5.run()
    smallbench_16000_5.write_avg_data()
    smallbench_16000_10.run()
    smallbench_16000_10.write_avg_data()
