...
\begin{document}
  \begin{tikzpicture}
    \begin{semilogxaxis}[title={Throughput for different max levels: sequental, size \ops},              % Title of the graph
      ...
      \addplot table {\DATAPATH/throughput/smallbench_\ops_5_seq.data};
      \addlegendentry{5 levels}
      \addplot table {\DATAPATH/throughput/smallbench_\ops_10_seq.data};
