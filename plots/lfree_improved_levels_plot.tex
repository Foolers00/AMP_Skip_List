...
\begin{document}
  \begin{tikzpicture}
    \begin{semilogxaxis}[title={Throughput for different max levels: lock free improved, size \ops},              % Title of the graph
      ...
      \addplot table {\DATAPATH/throughput/smallbench_\ops_5_lfree_improved.data};
      \addlegendentry{5 levels}
      \addplot table {\DATAPATH/throughput/smallbench_\ops_10_lfree_improved.data};
